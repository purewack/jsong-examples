...
You can download the songs to try out in the [jsong-player](https://github.com/purewack/jsong-player)!
Under [releases](https://github.com/purewack/jsong-examples/releases/tag/sources) you should be able to download 3 variants of jsongs packaged in an archive which you need to unarchive before use.

## Disclaimer 
Music in these examples is created by me, Damian Nowacki, and I ask that you do not use this music for your own benefit, do not copy or use anywhere outside educational purposes. Thank you :)
